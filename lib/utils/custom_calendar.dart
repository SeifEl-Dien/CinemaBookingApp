        ...
        children: [
          Padding(
            ...
            child: Text(
              //
              format
                  .format(CalendarController.instance.selectedMovieDate.value),
          ...
          Row(
            children: List.generate(
              ...
              (index) {
                ...
                DateTime text = CalendarController.instance.thisWeek[index - 1];
                ...
                return Padding(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      CalendarController.instance.updateMovieDate(text);
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          format.format(
                              CalendarController.instance.thisWeek[index - 1]),
                          style: TextStyle(
          ...
          Row(
            children: List.generate(
              ...
              (index) {
                ...
                DateTime text = CalendarController.instance.nextWeek[index - 1];
                final DateFormat format = DateFormat("dd");
                bool isSelected =
                    text == CalendarController.instance.selectedMovieDate.value;
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          format.format(
                              CalendarController.instance.nextWeek[index - 1]),
                          style: TextStyle(
                            color: isSelected ? Colors.white : Colors.black54,
                          ),
                        ),
